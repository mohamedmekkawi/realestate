	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<h3>Welcome!</h3>
				<p style="opacity:">Find the perfect home for you and your family. Meet home buyer's who are searching for you, or you search for them. With millions of people subscribed to our service, we at On Q8 are trying our best to put smiles on everyone's face.</p>
			</div>
			<div class="col-md-4 col-sm-6">
				<?php
				if(isset($_SESSION['login_MEMBERID'])){
					...
					if ($_SESSION['login_USERTYPE'] == 'buyer')
						print'
							<li><a href="users/ownerpost">Your Postings</a></li>
							<li><a href="users/ownerpost/newpost">Post an Ad</a></li>
							<li><a href="users/ownersearch">Search Tenant</a></li>
							<li><a href="users/owneraccount">Account Settings</a></li>
						';
					if ($_SESSION['login_USERTYPE'] == 'seller')
						print'
					...
					print '
					<h3>What is On Q8?</h3>
					<p>rentalmtl is a place where sellers and buyers create a trusting relationship to sleep soundly in their own beds.</p>
					';
				}
				?>
			</div>
			<div class="col-md-4 col-sm-12" >
				...
				<dl>
					<dt>For Seller:</dt>
					<dd>sellers have to simply have to set up a quick profile, and wait until a home buyer's finds you! Or search for homes that comfort your perferences.</dd>
					<dt>For buyer:</dt>
					<dd>Owners post houses or apartments, and wait for the seller to contact you. Or search for a sellers that is searching for a home.</dd>
				</dl>
			</div>
		</div>
		<hr>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-10  col-md-offset-1 text-center">
					<h3>Contact Us</h3>
					<p><small> <strong>John Abbott College</strong><br>
						21 275 Lakeshore Road <br>
						Sainte-Anne-de-Bellevue, Québec <br>
						H9X 3L9 Canada <br>
						Tel: 514-457-6610</small> </p>
					</div>
				</div>
				<p class="text-center col-md-12"r style="padding-top: 30px">
					<small>© Copyright On Q8, 2017. All rights reserved.</small>
				</p>
			</div>
		</footer>
